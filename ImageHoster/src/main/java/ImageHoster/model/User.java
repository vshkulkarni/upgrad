...
public class User {
    ...
    public String getPasswordTypeError() {
        return passwordTypeError;
    }

    public void setPasswordTypeError(String passwordTypeError) {
        this.passwordTypeError = passwordTypeError;
    }
}
